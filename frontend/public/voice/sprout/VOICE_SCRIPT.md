...
| `sprout-home-3.mp3` | This is your workspace. Overview, Chat, Drive and Plugins on the left. Every conversation lands in Recent Chats, with the credits it cost. |
